...
const persistState = createPersistedState({
  paths: ["user", "product.cached", "util.carrierDesc", "util.statusDesc", "util.shipmentMethodTypeDesc", "util.facilityAddresses", "util.sampleProducts", "util.dataManagerStatusDesc"],
  fetchBeforeUse: true
})

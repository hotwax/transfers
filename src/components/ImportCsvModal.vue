<template>
  <ion-header>
    <ion-toolbar>
      <ion-buttons slot="start">
        <ion-button data-testid="import-csv-close-btn" @click="closeModal()"> 
  ...
  <ion-content>
    <ion-item>
      <ion-select data-testid="import-csv-identifier-select" :label="translate('Product identifier')" interface="popover" :placeholder="translate('Select')" v-model="selectedIdentifier">
    ...
    <ion-list>
      ...
      <ion-item>
        <ion-select data-testid="import-csv-identifier-column-select" :label="translate('Identifier')" interface="popover" :placeholder="translate('Select')" v-model="selectedIdentifierColumn">
          <ion-select-option v-for="column in fileColumns" :key="column">{{ column }}</ion-select-option>
        </ion-select>
      </ion-item>
      <ion-item>
        <ion-select data-testid="import-csv-quantity-column-select" :label="translate('Quantity')" interface="popover" :placeholder="translate('Select')" v-model="selectedQuantityColumn">
          <ion-select-option v-for="column in fileColumns" :key="column">{{ column }}</ion-select-option>
        </ion-select>
      </ion-item>
    </ion-list>
    ...
    <ion-fab vertical="bottom" horizontal="end" slot="fixed">
      <ion-fab-button data-testid="import-csv-save-btn" @click="saveImportData">
